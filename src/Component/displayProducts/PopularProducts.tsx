...
const PopularProducts: React.FC = () => {
  ...
  if (!popularProducts.length) return <p>No popular products available.</p>;

  return (
    <div className="max-w-[1280px] mx-auto shadow-sm p-6 m-6 rounded-lg bg-white">
      <div className="flex justify-between items-center mb-6">
        <h1 className="font-medium text-[22px] leading-[27px] text-[rgb(51,51,51)]" style={{ fontFamily: 'Lato, sans-serif, SiyamRupali', fontWeight: 500 }}>Popular Products</h1>
      </div>
